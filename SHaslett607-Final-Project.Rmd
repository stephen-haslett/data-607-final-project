...
```{r, message=FALSE, warning=FALSE}
#test <- table(nyc_population$borough)
#test
crimes_dataframe <- as.data.frame(crimes_per_borough)
population_dataframe <- as.data.frame(nyc_population)
...
crimes_dataframe <- merge(crimes_dataframe, population_dataframe,by = c('Borough', 'borough'))
#crimes_dataframe %>% merge(nyc_population$borough)
crimes_dataframe
